...
class TokenManagementE2ETestCase(BaseTestCase):
    ...
    def test_token_obtain_pair_success(self):
        ...
        response = self.client.post(
            self.token_obtain_url, credentials, format="json"
        )
    ...
    def test_token_rotation_flow(self):
        ...
        login_data = {"username": "tokenuser", "password": "tokenpass123"}
    ...
    def test_complete_token_lifecycle(self):
        ...
        new_refresh_token = refresh_response.data.get(
        ...
        logout_response = self.client.post(
            logout_url, logout_data, format="json"
        )
        ...
        blacklisted_refresh_response = self.client.post(
            self.token_refresh_url, blacklisted_refresh_data, format="json"
        )
        self.assertEqual(
            blacklisted_refresh_response.status_code,

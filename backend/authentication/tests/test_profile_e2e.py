...
class ProfileE2ETestCase(BaseTestCase):
    ...
    def test_update_profile_partial_data(self):
        ...
        self.assertEqual(response.data['user']['last_name'], 'User')  # Should remain unchanged
        self.assertEqual(response.data['user']['email'], 'profile@example.com')  # Should remain unchanged
    ...
    def test_update_profile_readonly_fields(self):
        ...
        self.assertEqual(updated_user.first_name, 'ValidUpdate')  # This should change

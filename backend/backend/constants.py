...
# Security
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-2$o$w1jff2icu^6iqqh-%g3p+9pq4e2=dxon-gh#*p=in*#y*t')
DEBUG = os.getenv('DEBUG', 'True').lower() == 'true'
ALLOWED_HOSTS = os.getenv('ALLOWED_HOSTS', '').split(',') if os.getenv('ALLOWED_HOSTS') else []

# JWT Settings
JWT_ACCESS_TOKEN_LIFETIME = int(os.getenv('JWT_ACCESS_TOKEN_LIFETIME', '60'))  # minutes
JWT_REFRESH_TOKEN_LIFETIME = int(os.getenv('JWT_REFRESH_TOKEN_LIFETIME', '7'))  # days
